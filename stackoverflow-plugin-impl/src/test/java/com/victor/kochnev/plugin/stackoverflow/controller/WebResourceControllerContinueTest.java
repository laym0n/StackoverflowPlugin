...
import com.victor.kochnev.platform.api.dto.WebResourceContinueObservingRequest;
...
class WebResourceControllerContinueTest extends BaseControllerTest {
    private static final String CONTINUE_ENDPOINT = "/webresource";
    ...
    void testSuccessAddWebResource() {
        ...
        //Action
        MvcResult mvcResult = put(CONTINUE_ENDPOINT, request);
